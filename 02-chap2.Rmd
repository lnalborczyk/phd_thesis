...
```{r levelt, out.width = "100%", fig.cap = "Illustration of Levelt's (1989, 2000) model of speech production."}
...
```{r vocal, out.width = "75%", fig.cap = "Human respiratory and phonatory system. Figure from the OpenStax \\textit{Anatomy and Physiology} Textbook. Download for free at http://cnx.org/contents/14fb4ad7-39a1-4eee-ab6e-3ef2482e3e22@15.1."}
knitr::include_graphics("assets/vocal.jpg")
```
...
```{r ipa, out.width = "75%", fig.cap = "Illustration of the vocalic 'quadrilateral' and the relation between vowels and formants (F1 and F2). Figure adapted from the International Phonetic Association (2015) - IPA Chart, available under a Creative Commons Attribution-Sharealike 3.0 Unported License."}
knitr::include_graphics("assets/vowels.pdf")
```
...
```{r consonants, out.width = "100%", fig.cap = "Table of consonants according to the manner (in rows) and place (in columns) of articulation. Figure from the International Phonetic Association (2015) - IPA Chart, available under a Creative Commons Attribution-Sharealike 3.0 Unported License."}
knitr::include_graphics("assets/consonants.png")
```
...
```{r facial, out.width = "75%", fig.cap = "Illustration of the main facial muscles of interest in the present work. Figure adapted from Patrick J. Lynch, medical illustrator, http://patricklynch.net."}
knitr::include_graphics("assets/facial_muscles.pdf")
```
