...
```{r mfap, out.width = "75%", fig.cap = "Time course of the muscle fiber action potential (Figure from Kamen \\& Gabriel, 2010)."}
...
```{r emgplot3, fig.width = 6, fig.height = 4, fig.cap = "Illustration of the MAV (in orange) and RMS (in green) values. These two features are usually highly correlated but differ in magnitude."}
ts.plot(
  rectified_emg, xlab = "Time (samples)", ylab = "Rectified EMG signal",
  col = "steelblue"
  )
