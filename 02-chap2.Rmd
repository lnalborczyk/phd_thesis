...
```{r mfap, out.width = "75%", fig.pos = "H", fig.align = "center", fig.cap = "Time course of the muscle fiber action potential (from Kamen \\& Gabriel, 2010)."}
...
```{r muap, out.width = "75%", fig.pos = "H", fig.align = "center", fig.cap = "Motor unit action potential representation."}
...
```{r emgplot1, message = FALSE, fig.align = "center", fig.pos = "H", fig.width = 6, fig.height = 4, fig.cap = "Simulated EMG signal."}
...
```{r emgplot2, echo = FALSE, fig.align = "center", fig.pos = "H", fig.width = 6, fig.height = 4, fig.cap = "Rectified EMG signal."}
...
```{r emgplot3, fig.align = "center", fig.pos = "H", fig.width = 6, fig.height = 4, fig.cap = "Illustration of the MAV (in orange) and RMS (in green) values."}
ts.plot(
  rectified_emg, xlab = "Time (samples)", ylab = "Rectified EMG signal",
  col = "steelblue"
  )
