...
```{r 2Demg, fig.pos = "H", dev = "cairo_pdf", fig.align = "center", fig.width = 7, fig.height = 6, fig.cap = "Average EMG activity for each nonword in each condition, in the 2D space formed by the OOI and the ZYG."}
