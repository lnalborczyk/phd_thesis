...
![(\#fig:2Demg)Average EMG amplitude for each nonword in each condition, in the two-dimensional space formed by the OOI and ZYG muscles.](05-chap5_files/figure-docx/2Demg-1.pdf)
