...
Speech production requires the fine-grained timing and coordination of complex sequences of movements and can be considered as such a other forms of motor actions (cf.~biomechanical aspects of speech production in Chapter \ref{chap2}). Blah blah\ldots{} (for an introduction to motor control models and a review of speech motor control models, see Parrell, Lammert, Ciccarelli, \& Quatieri, \protect\hyperlink{ref-parrell_current_2019}{2019})\ldots{}

AVHs model\ldots{} frith\ldots guire\ldots{}Rapin (\protect\hyperlink{ref-Rapin2011}{2011}) and Rapin et al. (\protect\hyperlink{ref-Rapin2013}{2013}\protect\hyperlink{ref-Rapin2013}{b}) used surface electromyography to investigate the motor correlates of AVHs in patient with schizophrenia\ldots{} Oppenheim (\protect\hyperlink{ref-oppenheim_inner_2013}{2013})\ldots{} see also Tian \& Poeppel (\protect\hyperlink{ref-tian_mental_2012}{2012}), Tian (\protect\hyperlink{ref-tian_mental_2010}{2010}), and Tian, Zarate, \& Poeppel (\protect\hyperlink{ref-tian_mental_2016}{2016})\ldots{}
...
In the framework of motor control, these internal models have been postulated to be located in the cerebellum (Ito, \protect\hyperlink{ref-ito_control_2008}{2008}), although\ldots{}

The model of wilful (voluntary) inner speech production introduced in Lœvenbruck et al. (\protect\hyperlink{ref-loevenbruck_cognitive_2018}{2018}) goes one step further and, by building on the models of speech motor control (e.g., Houde \& Nagarajan, \protect\hyperlink{ref-houde_speech_2011}{2011}; Wolpert, Ghahramani, \& Jordan, \protect\hyperlink{ref-wolpert_internal_1995}{1995}), describes inner speech as \enquote{multi-modal acts with multi-sensory percepts stemming from coarse multi-sensory goals} (see Figure \ref{fig:loevenbruck}. In other words, the auditory and kinaesthetic sensations perceived during inner speech prediction are assumed to be the predicted sensory consequences of speech motor acts, emulated by internal forward models, that use the efference copies issued from an inverse model (this proposal shares similarities with the emulation model of motor imagery discussed earlier, Grush, \protect\hyperlink{ref-grush_emulation_2004}{2004}).
...
{\centering \includegraphics[width=1\linewidth]{assets/loevenbruck_epistemocritique} 

}

\caption{Predictive control account of inner speech production. Figure from L\oe venbruck (2019).}\label{fig:epistemocritique}
\end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{assets/Grandchamp2019_fig1} 

}

\caption{Predictive control account of inner speech production. Figure from Grandchamp et al. (submitted).}\label{fig:condialint1}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{assets/Grandchamp2019_fig2} 

}

\caption{Predictive control account of inner speech production. Figure from Grandchamp et al. (submitted).}\label{fig:condialint2}
\end{figure}
...
See introduction of O'Shea (\protect\hyperlink{ref-oshea_investigation_2017}{2017}) PhD thesis introduction\ldots and O'Shea \& Moran (\protect\hyperlink{ref-oshea_go_2018}{2018})\ldots{} See Stinear's chapter in Guillot's book for intracortical and spinal mechanisms involved during motor imagery (p.55-57).
...
The problem of inhibition (Jeannerod, 2001, page S106): how come that covert actions, in spite of activation of the motor system, do not result in muscular activity and overt movements? Two possibilities:

\begin{itemize}

\item   Subliminal activation during S-states, insufficient to fire spinal motoneurons...

\item   Or, activations would be blocked/attenuated before to reach the motoneurons by an inhibitory mechanism generated in parallel to the motor activation...
