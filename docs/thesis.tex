...
% Defense date
\Depot{the 17th of October 2019}
...
Articulatory suppression, images, reisberg, VTE\ldots{}

Many studies investigated the cerebral correlates of both overt speech and inner speech and show that both modes of speech production involve language areas in the left hemisphere, such as motor and premotor cortices in the frontal lobe, including Broca's aread or the left inferior frontal gyrus (IFG)\ldots{}

Decoding inner speech\ldots{} Rapin (\protect\hyperlink{ref-Rapin2011}{2011}) and Rapin et al. (\protect\hyperlink{ref-Rapin2013}{2013}\protect\hyperlink{ref-Rapin2013}{b}) used surface electromyography to investigate the motor correlates of AVHs in patient with schizophrenia\ldots{}
...
Interestingly, in this model, inner speech is thought to correspond to the phonetic plan. In other words, inner speech is considered as a plan for overt speech, something that precedes overt speech. The idea that inner speech is some sort of a plan for overt speech is widespread in psycholinguistics. According to Levelt, Roelofs, \& Meyer (\protect\hyperlink{ref-levelt_theory_1999}{1999}), we produce inner speech in the same way we produce overt speech, except that articulation is absent. One of the role of this covert mode in speak production would be to allow for monitoring planned speech for errors (e.g., Hartsuiker \& Kolk, \protect\hyperlink{ref-hartsuiker_error_2001}{2001}; Levelt, \protect\hyperlink{ref-levelt_monitoring_1983}{1983})\ldots{}

\begin{figure}

{\centering \includegraphics[width=0.75\linewidth]{assets/oppenheim} 

}

\caption{Inner speech's locus of generation. Depending on the framework, inner speech is thought to be specified at an articulatory level (motor simulation view) or not to be (abstraction view). Figure from Oppenheim \& Dell (2010).}\label{fig:oppenheim}
\end{figure}
...
Inner speech is central to Baddeley's theory of working memory. Baddeley (\protect\hyperlink{ref-baddeley_working_1986}{1986}) introduces in his model the \emph{subvocal rehearsal} component, whose role is to prevent decay in short term memory. This tripartite model comprises one central executive system and two slave systems. Within these slaves systems, verbal information is rehearsed within the phonological store through a mechanism known as the \emph{phonological loop}, acting to prevent memory loss in short term memory or working memory\ldots{}

Whereas studies have showed that children can store verbal information, the active (silent) rehearsal of verbal information seems somehow \enquote{deficient} before the age of 7 years (e.g., Flavell, Beach, \& Chinsky, \protect\hyperlink{ref-flavell_spontaneous_1966}{1966})\ldots{} which is coherent with Vygostky's predictions discussed earlier\ldots{}

Cf. recent attempt to integrate the verbal working memory and language literatures (Buchsbaum \& D'Esposito, \protect\hyperlink{ref-buchsbaum_sensorimotor_2019}{2019})\ldots{}
