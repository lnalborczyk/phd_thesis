...
In this chapter we briefly introduce some of the key concepts related to
the methods we used in our work. More precisely, we cover the technical
...
\ref{fig:levelt}). According to this model, speech production starts
with a message to be produced (\emph{message generation}), and is
managed by a component called the \emph{conceptualizer}. This
\emph{preverbal message} is then fowarded to another component, the
\emph{formulator}, that handles both grammatical encoding (i.e.,
selecting the appropriate word or \emph{lemma}) and phonological
encoding (i.e., selecting the appropriate speech sounds). In brief, this
...
transformed into speech acts. However\ldots{} In the next section, we
briefly introduce some of the cores principles related to the
...
muscles, the OOS and the OOI are placed over and below (respectively)
...
upwards and lateraly, and is involved in laughing and more generally in
