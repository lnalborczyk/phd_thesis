...
\hypertarget{history-of-ideas}{%
\subsubsection{History of ideas}\label{history-of-ideas}}

There is something paradoxical with inner speech. While we\footnote{Or most of us\ldots{} see hurlburt work\ldots{}} experience it on a daily basis, the precise nature is still poorly understood. To begin with a definition, by inner speech we refer to the activity of silently talking to oneself. This activity has been given many other names, such as covert speech, subvocal speech, verbal thinking, internal monologue, internal dialogue, speech imagery, auditory verbal imagery, silent talk, and so on (Morin, \protect\hyperlink{ref-morin_inner_2009}{2009}). The large number of names to designate the phenomeomn of inner speech might be explained by its fragmentary nature. On others words, we might have sevral names to designate it because it refers to differents phenomena, or to differnt forms of the more general action of talking to oneself silently\ldots{}

As noted by Vygotsky (\protect\hyperlink{ref-vygotsky_thought_2012}{2012}), the term of inner speech has been used to describe somehow different phenomena. Vygotsky (\protect\hyperlink{ref-vygotsky_thought_2012}{2012}) suggest that the term of inner speech has initially been employed to refer to \enquote{verbal memory}, citing for example the \enquote{silent recital of a peom known by heart} (p.238). Indeed, Cardaillac (\protect\hyperlink{ref-cardaillac_etudes_1830}{1830}) earlier said: \enquote{la parole intérieure n'est que le souvenir de la sensation que produit la parole extérieure} (quoted in Egger, \protect\hyperlink{ref-egger_parole_1881}{1881}, p. 53).\footnote{Which can be translated by \enquote{inner speech is only the memory of the sensation produced by external speech}.} The earlier investigations of inner indeed seem to revolve around the quesiton of knowing how words were reproduced in memory\ldots. auditory, visual or motor images\ldots{}

\ldots{} inner speaking and inner hearing Hurlburt, Heavey, \& Kelsey (\protect\hyperlink{ref-Hurlburt2013}{2013})\ldots{} inner voice and inner ear in memory research\ldots{} difference between imagination and imagery (see Wlkinson \& Fernuhough 2017)\ldots{}

A second perspective on inner speech sees it as truncated inner speech, that is, \enquote{speech minus sounds} of \enquote{subvocal speech} (Watson, \protect\hyperlink{ref-watson_psychology_1919}{1919}). In ine with his refelxology theory of thought, Sechenov called inner speech a reflex and wrote that \enquote{I never think directly in words, but always instead in mùuscular sensation which accompany my thought in the form of a conversation} (cited in Sokolov, \protect\hyperlink{ref-sokolov_inner_1972}{1972}, p. 4). It should be noted however, as highlighted by Sokolov (\protect\hyperlink{ref-sokolov_inner_1972}{1972}), that the behaviorist approach and the reflex approach differ in that the former consider that inner speech \enquote{originate} from peripheral muscular activations whereas the later consider inner speech to result from central (cerebral) processes\ldots{}\footnote{We discuss this distinction in more details later under the disguise of the centralist versus peripheralist debate.}

The question of the relation and intertwinnment of thought and language is one of the most enduring philsophical question\ldots{} egyptians, location of thought in the mouth\ldots{} (an anecdote related in Egger, \protect\hyperlink{ref-egger_parole_1881}{1881}, p. XX)\ldots{} Sokolov (\protect\hyperlink{ref-sokolov_inner_1972}{1972}) notes that ancient thinkers, by noticing a relation between thoughts and words, and between words and breathing, used to think that thoughts and wors originated in the lungs. Sokolov (\protect\hyperlink{ref-sokolov_inner_1972}{1972}) quots as an examples Socrates, in Plato's Phaedrus, who said that \enquote{his chest is full of thoughts}\ldots{}

Based on his own introspections, Stricker (\protect\hyperlink{ref-stricker_studien_1880}{1880}) reported that he was not able to mentally produce speech sounds without making movements ith the articulators. He also reported not being able to produce two different speech sounds, or to produce speech sounds that were incongruent with movement of the articulators. For instance, he suggested an experiment {[}inspired from\ldots{]}\ldots{}

However, Paulhan (\protect\hyperlink{ref-paulhan_langage_1886}{1886}) replied that he was able to produce (innerly) the vowel 1 and maintan the image of other vowels and that he was able to imagine the sound of any vowel without motor actions or feelings (images). Maybe this debats illustrates the limitations of the introspective method\ldots which gives birht to experimental methods atthe beginning of the last century\ldots{} for instance Reed (\protect\hyperlink{ref-reed_existence_1916}{1916}) desrbies an apparatus to examine tongue movements (see Figure XX) and an experiment to examine the inovlvment of inner spech (and speech motor processes) in thinking\ldots{}
...
\hypertarget{history-of-methods}{%
\subsubsection{History of methods\ldots{}}\label{history-of-methods}}
...
\hypertarget{the-production-of-inner-speech}{%
\subsection{The production of inner speech}\label{the-production-of-inner-speech}}

How do we produce speech ?

\hypertarget{the-development-of-inner-speech}{%
\subsection{The development of inner speech}\label{the-development-of-inner-speech}}

Development\ldots{} Watson (\protect\hyperlink{ref-watson_psychology_1919}{1919}), Piaget (1923), Vyogtsky (1934)\ldots{} development of AVHs\ldots{} two propositions highlighted by Fernyhough (\protect\hyperlink{ref-fernyhough_alien_2004}{2004}): either a disruption of internalisation (in the devleopment) or a re-expansion model\ldots{}
...
\hypertarget{theoretical-perspectives-on-inner-speech-production}{%
\subsection{Theoretical perspectives on inner speech production}\label{theoretical-perspectives-on-inner-speech-production}}
...
\hypertarget{motor-theories-of-voluntary-thinking}{%
\subsubsection{Motor theories of voluntary thinking}\label{motor-theories-of-voluntary-thinking}}

The \emph{motor theory of voluntary thinking} (MTVT, Cohen, \protect\hyperlink{ref-cohen_motor_1986}{1986})\ldots{} notes that a critical aspect of motor theories is that they rely on peripheral motor feedback (i.e., afferent feedback from the contraction of the muscles. Hoewver, he then suggest that although motor feedback might be necessay at the initial stages of an internalised action (as inner speech), these feedbacks might becore unnecessary through repeated associations that would \enquote{short-circuit connections within the central nervous system} (Cohen, \protect\hyperlink{ref-cohen_motor_1986}{1986}, p. 21)\ldots{} the MTVT suggests that mtor activity would be necessary for meantal experiences without external sensatio (i.e., for imagery or thoughts). Building on ({\textbf{???}}) definition of kinaethetic images\ldots{} suggests that inner speech (or rather, the sensory percepts associated with inner speech) might be explained by its associations with motor activity. Indeed, according to Cohen (\protect\hyperlink{ref-cohen_motor_1986}{1986}), \enquote{associations between one's voice and kinesthetic sensations from one's speech musculature are very specific, consistent, and frequently repeated} (p.22). Therefore, slight (unconscious) contractions of the speech musculature might evoke speech auditory images. In support of this idea, Cohen reports the results of an interesting epxeirment lead by Hefferline \& Perera (1963): \enquote{when the subject occasionnaly emitted an invisibly small thumb twitch (detected electromyographically), he received a tone as a signal to press a key. After several conditioning sessions, the tone was progressively diminished to zero. The subject nevertheless cotonued to press the key whenever he emitted a thumb twitch, and he reported that he still heard the tone.}\ldots{} Cohen then moves to a presentation of the motor theory of attention, according to which motor activity allows oneself to emphasise (or weight) one aspct of perception over another\ldots{} The MTVT, while not suggesting that motor activity for any sort of mental image or thought, suggests that motor feedback \emph{can} evoke mental images and thoughts (e.g., via the principle of association discussed above) and that motor activity is reponsible for forthe experience of volition in thinking. This idea is consistent with self-monitoriing models and motor control model of inner speech production. The MVT suggests that thoughts that are experienced voluntary (e.g., rehearsing a novel phone number) are accompanid by motor activity whereas non voluntary thoughts (e.g., intrusive thoughts or ruminative thoughts) are not. Interestingly, Cohen also suggests that \enquote{a thought may appear to be effortless because no motor activation is involved, or because the motor activity is of an automatic nature} (p.27)\ldots{}

The hierarchical model of mental practice (Mackay, \protect\hyperlink{ref-mackay_problem_1981}{1981})\ldots{}
...
Lœvenbruck et al. (\protect\hyperlink{ref-loevenbruck_cognitive_2018}{2018})\ldots{}
...
James, W. (1890). \emph{The principles of psychology, Vol I.} New York, NY, US: Henry Holt; Co. \url{https://doi.org/10.1037/10538-000}
