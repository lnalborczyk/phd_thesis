...
To examine the efficiency of the induction procedure (i.e., the effects of time, coded as \emph{Session}, and the effects of the thinking mode, coded as \emph{Think}) while controlling for the other variables (i.e., \emph{RRSbrooding} and \emph{BDI.II}), we then compared the parsimony of models containing main constant effects and a varying intercept for \emph{Participant}. Model comparison showed that the best model (i.e., the model with the lowest WAIC) was the model including \emph{Session}, \emph{RRSbooding}, \emph{BDI.II}, and an interaction term between \emph{Session} and \emph{RRSbrooding} and between \emph{Session} and \emph{BDI.II} (see Table \ref{tab:compexp1}). Fit of the best model was moderate (\(R^2\) = 0.444, 95\% CrI {[}0.111, 0.638{]}).
...
\toprule
 & \multicolumn{1}{c}{$WAIC$} & \multicolumn{1}{c}{$pWAIC$} & \multicolumn{1}{c}{$\Delta_{WAIC}$} & \multicolumn{1}{c}{$Weight$}\\
\midrule
$Int+Ind+RRSbro+BDI+Ind:RRSbro+Ind:BDI$ & 1049.64 & 19.29 & 0.00 & 0.806\\
$Int+Ind+RRSbro+Ind:RRSbro$ & 1053.82 & 25.09 & 4.18 & 0.100\\
$Int+Ind+BDI+Ind:BDI$ & 1054.67 & 19.13 & 5.03 & 0.065\\
$Int+Ind+BDI$ & 1057.47 & 16.84 & 7.83 & 0.016\\
$Int+Ind+Think+Ind:Think+BDI$ & 1058.12 & 17.24 & 8.47 & 0.012\\
$Int+Ind+RRSbro$ & 1063.62 & 22.76 & 13.97 & 0.001\\
$Int+Ind+Think+Ind:Think+RRSbro$ & 1064.74 & 22.73 & 15.10 & 0.000\\
$Int+Ind$ & 1066.71 & 25.82 & 17.07 & 0.000\\
$Int+Ind+Think+Ind:Think$ & 1067.67 & 26.24 & 18.03 & 0.000\\
\bottomrule
\addlinespace
\insertTableNotes
\end{longtable}
...
Constant effect estimates for the best model are reported in Table \ref{tab:paramexp1}. Based on these values, it seems that \emph{Session} (i.e., the effect of the rumination induction) increased self-reported rumination state (i.e., BSRI sum score) by approximately 10.73 points on average (\(\beta\) = 10.734, 95\% CrI {[}-8.164, 28.959{]}, \(BF10\) = 1.75). The main positive effect of \emph{BDI.II} and \emph{RRSbrooding} indicate higher BDI-II and RRS brooding subscale scores were associated with higher self-reported state rumination scores overall. The interaction between \emph{Session} and \emph{RRSbrooding} reveals that higher scores on the brooding subscale of the RRS were associated with higher increase of self-reported state rumination from baseline to post-induction (\(\beta\) = 1.617, 95\% CrI {[}-17.369, 19.502{]}, \(BF10\) = 0.936).
...
Term & \multicolumn{1}{c}{Estimate} & \multicolumn{1}{c}{SE} & \multicolumn{1}{c}{Lower} & \multicolumn{1}{c}{Upper} & \multicolumn{1}{c}{Rhat} & \multicolumn{1}{c}{BF10}\\
\midrule
Intercept & 79.073 & 29.753 & 14.994 & 138.678 & 1.000 & 75.01\\
Session & 3.423 & 10.109 & -15.075 & 22.567 & 1.000 & 1.075\\
RRSbrooding & 10.217 & 5.391 & -0.287 & 20.632 & 1.000 & 3.016\\
BDI.II & 9.934 & 2.032 & 5.745 & 13.832 & 1.001 & 1.138*10\textasciicircum{}11\\
Session x RRSbrooding & 9.041 & 5.783 & -3.196 & 19.796 & 1.000 & 1.977\\
Session x BDI.II & 0.851 & 2.920 & -5.224 & 6.286 & 1.000 & 0.304\\
\bottomrule
\addlinespace
\end{tabular}
}
...
Term & \multicolumn{1}{c}{Estimate} & \multicolumn{1}{c}{SE} & \multicolumn{1}{c}{Lower} & \multicolumn{1}{c}{Upper} & \multicolumn{1}{c}{Rhat} & \multicolumn{1}{c}{BF10}\\
\midrule
Intercept & 223.111 & 21.995 & 178.253 & 264.272 & 1.001 & -9.146*10\textasciicircum{}137\\
Session & 11.002 & 9.712 & -8.360 & 29.975 & 1.000 & 1.886\\
Thinking mode & -0.574 & 9.405 & -18.686 & 17.981 & 1.000 & 0.93\\
Session x Thinking mode & 0.043 & 9.873 & -19.754 & 19.672 & 1.000 & 1.009\\
\bottomrule
\addlinespace
\end{tabular}
}
...
{\centering \includegraphics[width=1\linewidth]{07-chap7_files/figure-latex/unnamed-chunk-2-1} 

}

\caption{Average self-reported levels of state rumination (BSRI sum score) throughout the experiment, that is, by session, thinking style and type of motor activity. Smaller dots represent individual scores.}\label{fig:unnamed-chunk-2}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{07-chap7_files/figure-latex/unnamed-chunk-3-1} 

}

\caption{Average self-reported levels of state negative affects (PANAS) by thinking style and type of motor activity at the beginning (baseline) and end (motor) of the experiment. Smaller dots represent individual scores.}\label{fig:unnamed-chunk-3}
\end{figure}
