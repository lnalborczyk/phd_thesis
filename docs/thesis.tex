...
To begin with the broadest definition possible, we use the term of inner speech to refer to the activity of silently talking to oneself. Whereas the exact nature of inner speech is still the matter of lively ongoing debates, we can nevertheless attribute some basic and consensual observations to inner speech. Gregory (\protect\hyperlink{ref-gregory_inner_2017}{2017}) list some consensual properties of inner speech, namely, that i) inner speech takes place in the mind, ii) an instance of inner speech is a linguistic occurrence, iii) inner speech is episodic (it occurs at a given moment in time), iv) an episode of inner speech involves mental imagery (may it be auditory or kinaesthetic), v) inner speech can be used in the service of working memory, vi) inner speech does not \emph{necessarily} (and often does not) take the form of complete grammatical sentences (cf.~our later discussion of the Vygotskian theory of inner speech development), vii) we do not have the same level of control upon our inner and overt speech (whereas it is easy to stop producing external speech, it can be quite arduous to override inner speech)\ldots{}

While we experience this phenomenon on a daily basis\footnote{Or most of us. See hurlburt's work\ldots{}}, it is nevertheless arduous to investigate in a controlled environment. Even more dramatically, some authors have suggested that the more we look at it, the more evanescent it appears. We have been using many names to designate this phenomenon, such as covert speech, subvocal speech, verbal thinking, internal monologue, internal dialogue, speech imagery, auditory verbal imagery, silent talk, and so on. This plethora of names might be explained by the diversity of the phenomenon. In others words, if we have so many names to designate this phenomenon, it might be because it refers to actually different phenomena, or to different forms of the more general action of talking to oneself silently\ldots{}
...
As noted by Vygotsky (\protect\hyperlink{ref-vygotsky_thought_2012}{2012}), the term of inner speech has been used to describe somehow different phenomena. Vygotsky (\protect\hyperlink{ref-vygotsky_thought_2012}{2012}) suggested that the term of inner speech has initially been employed to refer to \enquote{verbal memory}, citing for example the \enquote{silent recital of a peom known by heart} (p.238). Indeed, Cardaillac (\protect\hyperlink{ref-cardaillac_etudes_1830}{1830}) earlier said: \enquote{la parole intérieure n'est que le souvenir de la sensation que produit la parole extérieure} (as quoted in Egger, \protect\hyperlink{ref-egger_parole_1881}{1881}, p. 53).\footnote{Which can be translated by \enquote{inner speech is only the memory of the sensation produced by external speech}.} The early investigations of inner speech throughout the XIXth century indeed seem to revolve around the quesiton of knowing how words were reproduced in memory (either as auditory, visual or motor images).

According to the second perspective listed by Vygotsky (\protect\hyperlink{ref-vygotsky_thought_2012}{2012}), inner speech could be conceived as truncated overt speech, that is, \enquote{speech minus sounds} or \enquote{subvocal speech} (Watson, \protect\hyperlink{ref-watson_psychology_1919}{1919}). In line with his reflexologist theory of thought, Sechenov called inner speech a reflex and wrote: \enquote{I never think directly in words, but always instead in muscular sensation which accompany my thought in the form of a conversation} (cited in Sokolov, \protect\hyperlink{ref-sokolov_inner_1972}{1972}, p. 4). It should be noted however, as highlighted by Sokolov (\protect\hyperlink{ref-sokolov_inner_1972}{1972}), that the behaviourist approach and the reflex approach differ in that the former consider that inner speech \enquote{originate} from peripheral muscular activations, whereas the later consider inner speech to result from central (cerebral) processes. According to that latter perspective, the peripheral muscular activity recorded during imagined actions (or inner speech) would be a side-effect of these central processes.\footnote{We discuss this distinction in more details later under the disguise of the centralist versus peripheralist debate.}

According to Vygotsky (\protect\hyperlink{ref-vygotsky_thought_2012}{2012}), a third interpretation of inner speech would refer, following Kurt Goldstein, to everything that \enquote{prcedes the motor act of speaking}\ldots{}

The question of the relation and intertwinment of thought and language is one of the most enduring philosophical question. Most noticeable examples can be traced back to Plato's theaetetus, in which Plato defines thinking as \enquote{the conversation which the soul holds with itself in considering anything}. For Plato, the definition of thinking is then taken to correspond to \enquote{word{[}s{]} spoken in silence}. Sokolov (\protect\hyperlink{ref-sokolov_inner_1972}{1972}) notes that ancient thinkers, by noticing a relation between thoughts and words, and between words and breathing, used to think that thoughts and words originated in the lungs. For instance, Socrates, in Plato's Phaedrus, said that \enquote{his chest is full of thoughts} (as quoted in Sokolov, \protect\hyperlink{ref-sokolov_inner_1972}{1972}, p. 14). By noting the progressive internalisation of external speech into inner speech druing normal development (we wil discuss this further in the following) Egger (\protect\hyperlink{ref-egger_parole_1881}{1881}) wonders whether the phylogeny (the evolution of the species) followed the same course of development as. In support of that idea, Egger (\protect\hyperlink{ref-egger_parole_1881}{1881}) reports the eistence of an ancient Egyptian ideogram. This ideogram represent a crouched man, with the right hand close to the mouth. Egger (\protect\hyperlink{ref-egger_parole_1881}{1881}) explains that this ideogram was meant to represent undistinctly the ideas of eating, drinking, screaming, talking, meditating, knowing or judging, suggesting that thought was thought to be localised in the mouth (p.84).

Based on his own introspections, Stricker (\protect\hyperlink{ref-stricker_studien_1880}{1880}) reported that he was not able to mentally produce speech sounds without making movements ith the articulators. He also reported not being able to produce two different speech sounds, or to produce speech sounds that were incongruent with movement of the articulators. For instance, he suggested an experiment {[}inspired from\ldots{]}, described in James (\protect\hyperlink{ref-james_principles_1890}{1890})\ldots{} Stricker suggested to open your mouth and to try to pronounce a word with labials or dentalsin it, such as \enquote{bubble} or \enquote{toddle}. Ask yourself whether the image of the word (your inner speech) is clear or distinct ? According to Stricker and James, most people (including myself) find that it is difficult to imagine cleary these words with the mouth being open. Instead, the image of the work is reather imprecies and sounds like we were rying to produce the word with the mouth open\ldots{} the following citation from Bain (\protect\hyperlink{ref-bain_senses_1855}{1855}):
...
James (\protect\hyperlink{ref-james_principles_1890}{1890}) then notes that Stricker, \enquote{Like most psychologists, however, he makes of his personal peculiarities a rule, and says that verbal thinking is normally and universally an exclusively motor representation.} In this vein, Paulhan (\protect\hyperlink{ref-paulhan_langage_1886}{1886}) replied to Stricker that he was able to produce (innerly) the vowel 1 and maintan the image of other vowels and that he was able to imagine the sound of any vowel without motor actions or feelings (images).

Maybe this debate illustrates the limitations of the introspective method\ldots{} following James (\protect\hyperlink{ref-james_principles_1890}{1890}), researchers then tried to find more objective methods to assess inner speech, or as put by Reed (\protect\hyperlink{ref-reed_existence_1916}{1916}), to go beyond introspection and to look for the \enquote{stamp of objective certainty}. In that vein, Reed (\protect\hyperlink{ref-reed_existence_1916}{1916}) describes an apparatus to examine tongue movements (see Figure \ref{fig:reed}) and an experiment to examine the involvement of inner spech (and speech motor processes) in thinking\ldots{}

See Reed (\protect\hyperlink{ref-reed_existence_1916}{1916}) for an historical perspective\ldots{} this initial suggestion (by watson) lead to a fruitful line of research about the muscular bases and/or correlates of thought and inner speech\ldots for instance, Reed (\protect\hyperlink{ref-reed_existence_1916}{1916}) observed that participnts were moving their tongue and lips (and sometimes whispering) while reading\ldots{}
...
A tentative non-exhaustive timeline of the last 170 years (from 1850 to present days) of inner speech research is presented in Figure \ref{fig:timeline}\ldots{}

Like most psychological phenomena, the study of inner speech started with introspective observations (Morin, \protect\hyperlink{ref-morin_inner_2009}{2009}). Blah blah \ldots see morin \& uttl\ldots{} recording of private speech of children in naturalistic environments (e.g., in the classrom) or in the laboratory. Moreover, think out loud methods have been devleoped, where participants are asked to (overtly) produce their though while being engaged in some task. A problem of this method is related to the re-expansion (Fernyhough, \protect\hyperlink{ref-fernyhough_alien_2004}{2004})\ldots{} we discuss this issue further later\ldots{}

Thought listing\ldots{} thought sampling\ldots{} descriptive experience sampling method\ldots{} notebooks\ldots{}

Physiological mesurements\ldots{}

Neuroanatomy of inner speech production\ldots{}
...
The developmental course of inner speech might be one of the most investigated issue related to\ldots{} of the first part of the XXth century. Watson (\protect\hyperlink{ref-watson_psychology_1919}{1919}), Piaget (1923), and most famously Vyogtsky (1934) atacked this question\ldots{} For Vygotsky, the stuy of inner speech in the mature (i.e., adult) brain can only be undrstood from the perspective of the development of inner speech\ldots{}
...
Gregory (\protect\hyperlink{ref-gregory_inner_2017}{2017}) adresses three important questions about inner speech, namely i) the question of what it is (e.g., an actual occurrence of speech or imagined speech), ii) thepurpotedly dialogical property of inenr speech, iii) whether inner speech can be a source of knowledge about oneself's beliefs and iv) the relation between inner speech and AVHs\ldots{}

Inner speech as actual speech or imagined speech ? see Gregory (\protect\hyperlink{ref-gregory_inner_2017}{2017}) and Gregory (\protect\hyperlink{ref-gregory_inner_2016}{2016})\ldots{}
