...
Ackermann \& Riecker (\protect\hyperlink{ref-ackermann_contribution_2004}{2004}) observed an activation of the left supplementary motor area (SMA), left primary motor cortex (M1), and right cerebellum during covert speech\ldots{} speech arrests\ldots{} Fried et al., (1999) induced speech arrests on the left and right SMA (and in a lot of places, sometimes associate with involuntary movement of various articulators)\ldots{} cf.~the cerebral landscape of (wilfull) inner speech production in the next section\ldots{}

More recently, the advancing of neuroimaging and intracortical recordings methods from the filed of neural engineering paved the way for new ways of investigating inner speech\ldots{} Several teams are now conducting research with the aim of \enquote{decoding inner speech}, that is, decyphering the content of inner speec based on neurophysiological signals. For instance\ldots{} studies using electrocorticographic (ECoG, also known as intracranial electroencephalography or iEEG) recordings\ldots{} Martin et al. (\protect\hyperlink{ref-martin_decoding_2014}{2014})\ldots{} Martin et al. (\protect\hyperlink{ref-martin_word_2016}{2016})\ldots{} (for a review, see Martin, Iturrate, Millán, Knight, \& Pasley, \protect\hyperlink{ref-martin_decoding_2018}{2018}). Using surface electromyography and appropriate signal processing algorithms, Kapur et al. (\protect\hyperlink{ref-kapur_alterego_2018}{2018}) developed a wearable device capable of discriminating inner speech content. They showed that their methods was able to discriminate with relatively high accuracy what digits (between 0 and 9) the user was producing covertly\ldots{}
