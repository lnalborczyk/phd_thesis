...
Another important indirect source of information with regards to the nature of inner speech comes from studies interfering with inner speech in order to make causal claims about inner speech. These studies include for instance articulatory suppression studies at the behavioural level and transcranial magnetic stimulation (TMS) studies at the neural level. The concept of articulatory suppression refers to a task which requires participants to utter speech sounds (or to produce speech gestures without sound), so that this activity disrupts ongoing speech production processes. Articulatory suppression can be produced with different degrees of vocalisation, going from overt uttering of irrelevant words, to whispering, mouthing (i.e., silent articulation), and simple clamping of the speech articulators. Many studies have shown that articulatory suppression can be used to disrupt the subvocal rehearsal mechanism of verbal working memory and --as a consequence-- impair the recall of verbal material (e.g., Baddeley et al., \protect\hyperlink{ref-baddeley_exploring_1984}{1984}; Larsen \& Baddeley, \protect\hyperlink{ref-larsen_disruption_2003}{2003}). Reisberg, VTE\ldots{} speech arrests\ldots{}

Using repetitive transcranial magnetic stimulation (rTMS), Aziz-Zadeh, Cattaneo, Rochat, \& Rizzolatti (\protect\hyperlink{ref-Aziz-Zadeh2005}{2005}) induced both overt and covert speech arrests (i.e., a transient inability to produce speech) by targeting both a motor and a \enquote{non-motor} area of the left hemisphere. However, the effects of the stimulation were restricted to the temporal range of the actual stimulation. More recently, neurostimulation has been used to investigate the role of the articulatory motor cortex in speech perception, mostly by the way of two means. First, TMS can be used to induce peripheral muscles activations that can be recorded using electromyography (these TMS-induced activation are called motor evoked potentials or MEPs). Second, rTMS can be used to induce a temporary disruption (i.e., a virtual lesion) in the motor cortex. For instance, Möttönen, Rogers, \& Watkins (\protect\hyperlink{ref-Mottonen2014}{2014}) shown that a 15-min train of low frequency (0.66Hz) sub-threshold repetitive stimulation of the lip representation on the motor cortex can suppress motor excitability for a further 15-20min, and impair subsequent performance on a speech discrimination task. One limitation of low-frequency rTMS though is that duration of the observed modulatory effects seems to be roughly equivalent to the length of the stimulation (i.e., the effects last approximately 15min following 15min of rTMS). Rogers, Möttönen, Boyles, \& Watkins (\protect\hyperlink{ref-Rogers2014}{2014}) instead used continuous theta-burst stimulation (cTBS) over the primary motor cortex, and shown that a relatively short train of cTBS (e.g., 40sec) can produce a long-lasting disruption in the motor cortex (up to 60min)\ldots{}
...
\initial{S}ummary of the research\ldots{}\footnote{This experimental chapter is a published paper reformatted for the need of this thesis. Source: Nalborczyk, L., Perrone-Bertolotti, M., Baeyens, C., Grandchamp, R., Polosan, M., Spinelli, E., \ldots{} L\oe venbruck, H. (2017). Orofacial Electromyographic Correlates of Induced Verbal Rumination. \emph{Biological Psychology, 127}, 53-63. \url{https://dx.doi.org/10.1016/j.biopsycho.2017.04.013}.}
...
\leavevmode\hypertarget{ref-Mottonen2014}{}%
Möttönen, R., Rogers, J. C., \& Watkins, K. E. (2014). Stimulating the lip motor cortex with transcranial magnetic stimulation. \emph{Journal of Visualized Experiments : JoVE}, (88), 1--7. \url{https://doi.org/10.3791/51665}
...
\leavevmode\hypertarget{ref-Rogers2014}{}%
Rogers, J. C., Möttönen, R., Boyles, R., \& Watkins, K. E. (2014). Discrimination of speech and non-speech sounds following theta-burst stimulation of the motor cortex. \emph{Frontiers in Psychology}, \emph{5}, 1--13. \url{https://doi.org/10.3389/fpsyg.2014.00754}
