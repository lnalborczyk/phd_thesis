...
\subsubsection{The development and production of inner speech}\label{the-development-and-production-of-inner-speech}}

The developmental course of inner speech is possibly the most investigated issue related to inner speech in the first part of the XXth century. Watson (\protect\hyperlink{ref-watson_psychology_1919}{1919}), Piaget (1923), Luria, Leontiev, and most famously Vygotsky (\protect\hyperlink{ref-vygotsky_thought_2012}{2012}) attacked this question. For Vygotsky, the study of inner speech in the mature (i.e., adult) brain can only be understood from a developmental perspective\ldots{}

Fundamentally, Vygostky believed that language was a psychological tool and that its development during childhood interact wth the development of abstract thinking\ldots{} Vygotsky observed, as Piaget (1959) before him, that the child tends to spek (aloud) to himself while playing\ldots{} Piaget characterised this form of speech as \enquote{egocentric speech} because in this form of speech, accoding to Piaget, the child does not try to take the perspective of the listener\ldots{} Piaget thoughts that this form of speech disappears at the age of seven or eight\ldots{} in contrast, Vygotsky thought so-called egocentric speech (or private speech) continues but that it becomes more and more internalised, until reaching the status of \enquote{inner} speech\ldots{} In other words, for Vygotsky, inner speech inherts the function of private (overt) speech, as it follows the internalisation of private speech\ldots the \enquote{internal reconstruction of an external operation}\ldots{} Vygotsky believed inner speech to result from a progressvie internalisaiton process. This process starts with social speech, that is speech addressed to others. During development, this form of speech evolves to either communicative speech (speech adressed to others) and so-called egocentric speech (speech adressed overtly to oneself). This form of speech appears naturally in children while being faced with a problem to solve, but also in adults facd with difficult problems. This egocentric speech would then became internalised, resulting in what we call inner speech\ldots{}
...
\hypertarget{inner-speech-research-in-the-second-part-of-the-xxth-century}{%
\subsubsection{Inner speech research in the second part of the XXth century}\label{inner-speech-research-in-the-second-part-of-the-xxth-century}}

The first investigation of covert behaviour using electromyography (EMG)\footnote{See Chapter 2 for a brief introduction to (surface) electromyogaphy.}\ldots{}
