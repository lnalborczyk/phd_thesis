...
%\usepackage[T1]{fontenc} % special characters with xelatex
...
According to Vygotsky (\protect\hyperlink{ref-vygotsky_thought_2012}{2012}), a third interpretation of inner speech would refer to everything that \enquote{precedes the motor act of speaking}. In other words, inner speech would include speech \enquote{motives} (or intentions) and the preverbal message that precedes speech production. We will come back to that position briefly when mentioning psycholinguistic models of speech production (e.g., {\textbf{???}}) as well as the motor simulation model of motor imagery (e.g., Jeannerod, \protect\hyperlink{ref-jeannerod_motor_2006}{2006}). However, for the purpose of the current section, we are mostly concerned with the first and second position, namely, the view of inner speech as either imagined or actual speech.
...
Besides using mental chronometry and electromyography, the second part of the last century also witnessed a revival of introspective methods with the aime of refining the description of the phenomelogical properties of inner speech\ldots experience sampling\ldots{}
...
The experiment was video-monitored using a Sony HDR-CX240E video camera to track any visible facial movements. A microphone was placed 20--30 cm away from the participant's lips to record any faint vocal production during rumination. Stimuli were displayed using the OpenSesame software ({\textbf{???}}) on a 19-inch colour monitor.
...
The experiment was programmed with OpenSesame software ({\textbf{???}}) and stimuli were displayed on a DELL latitude E6500 computer screen.
...
Bürkner, P.-C. (2018). Advanced Bayesian Multilevel Modeling with the R Package brms. \emph{The R Journal}, \emph{10}(1), 395--411. Retrieved from \url{https://journal.r-project.org/archive/2018/RJ-2018-017/index.html}
