...
A number of studies suggest that different forms of rumination might be distinguished according to their functionnal or dysfuncitonal outcomes. The theory of processing mode [@watkins_adaptive_2004;@Watkins2008]...

The cognitive approach [@Koster2011;@Koster2013]... that can be further subdivided into three classes (see van vugt et al, 2018)...

From the RST to control theories and the mental habit theory...
...
![(\#fig:conceptual)Conceptual space of different types of thought (Christoff et al., 2016)](assets/conceptual_space.png)
